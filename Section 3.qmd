...
title: "Section 3"
format: html
include-after-body: scripts/quiz.js
css: styles/quiz.css
---
...
Some of these databases are free to use with an account(\*) and some of these are accessible via University of Manchester subscriptions(^+^). They all have a search function which will allow you to search for your name and/or Researcher ID such as [ORCID](https://support.orcid.org/hc/en-us){target="_blank"} and from there you can review how your research has been indexed by these systems. 

Using more than one source of metrics is a good practice as systems index at different rate and speeds. 

Contact the [Office for Open Research](https://www.openresearch.manchester.ac.uk/contact/){target="_blank"} for support, with as much notice as possible. 

### University of Manchester Resources for Metrics

The University of Manchester provides extensive support for understanding and using research metrics responsibly:

- **[Library Guide on Responsible Metrics](https://subjects.library.manchester.ac.uk/research-metrics/responsible-metrics){target="_blank"}**: Comprehensive guidance on frameworks, tools, and best practices
- **[My Research Essentials Training](https://www.education.library.manchester.ac.uk/mre/citation-analysis/#){target="_blank"}**: Online resource for using citation analysis to measure research impact
- **[Medium Series on Responsible Metrics](https://medium.com/research-metrics-matters/part-1-introduction-to-responsible-research-metrics-part-1-4fbe385dd0c4){target="_blank"}**: Three-part introduction covering definitions, usage, and risks
- **[Office for Open Research](https://www.openresearch.manchester.ac.uk/contact/){target="_blank"}**: Contact for bespoke consultancy, citation analysis, and research intelligence tools
...
At the University of Manchester, we address some limitations through field-normalized citation metrics and percentile rankings, which account for disciplinary differences in citation practices.
...
Thank you for taking the time to complete this section of the course. If you need additional help and support with your own applications please contact the [Office for Open Research](https://www.openresearch.manchester.ac.uk/contact/){target="_blank"} for support.
...
Read the [University responsible metrics policy](https://documents.manchester.ac.uk/DocuInfo.aspx?DocID=75142){target="_blank"}

Visit our [Research Indicators](https://www.openresearch.manchester.ac.uk/research-services/research-indicators/){target="_blank"}

Specific question? Contact us at patrick.parkinson\@manchester.ac.uk

### Test Your Knowledge

<div class="quiz" data-quiz="quizzes/test_your_knowledge.json"></div>

<noscript>
<p>This quiz requires JavaScript. For an alternative, please contact us at patrick.parkinson@manchester.ac.uk</p>
</noscript>
