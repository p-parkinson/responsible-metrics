...
The University of Manchester was one of the first UK signatories to DORA, demonstrating our commitment to using metrics responsibly.

[**The Metric Tide**](https://rori.figshare.com/articles/report/Harnessing_the_Metric_Tide/21701624?file=38515103){target="_blank"}

The Metric Tide is a 2015 UK report that outlines five principles for responsible metrics use in research assessment:

- **Robustness**: Basing metrics on the best possible data in terms of accuracy and scope
- **Humility**: Recognising that quantitative evaluation should support, not supplant, qualitative expert assessment
- **Transparency**: Keeping data collection and analytical processes open and verifiable
- **Diversity**: Accounting for variation by field and supporting diverse research paths
- **Reflexivity**: Regularly reviewing and updating practices in light of new evidence

The University of Manchester endorses these principles as part of our responsible metrics approach.
