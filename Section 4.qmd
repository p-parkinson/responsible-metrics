...
-   Ask the metrics service to provide metrics for the group of candidates so that everyone will be assessed in the same way at the same time. Please contact us at patrick.parkinson\@manchester.ac.uk to discuss.
...
### University of Manchester's Policy on Assessing People Using Metrics

The University of Manchester is committed to fair assessment practices:

- **No Journal-Based Metrics for Individuals**: As a DORA signatory, we do not use Journal Impact Factors or similar metrics to assess individual researchers' contributions, hiring, promotion, or funding decisions
- **Judicious Use of Citation Data**: Individual-level citation metrics are used sparingly, only as one part of a broader evaluation including peer review and qualitative assessment
- **Context-Aware Evaluation**: We recognize that citation practices vary by discipline and can disadvantage underrepresented groups (women, minorities, non-English language publications)
- **Support for Assessors**: Contact the [Office for Open Research](https://www.openresearch.manchester.ac.uk/contact/){target="_blank"} for guidance on responsible assessment practices

This ensures that decisions about recruitment, promotion, and funding are based on comprehensive evaluation rather than flawed metrics.
